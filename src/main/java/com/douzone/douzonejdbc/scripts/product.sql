...
INSERT INTO PRODUCT_IO (IO_NUM, PRODUCT_ID, AMOUNT, STATUS) VALUES (IO_NUM_AUTO_INCREMENTS_SEQ.nextval,'nb_ss7',30,'입고');
INSERT INTO PRODUCT_IO (IO_NUM, PRODUCT_ID, AMOUNT, STATUS) VALUES (IO_NUM_AUTO_INCREMENTS_SEQ.nextval,'nb_ss7',3,'출고');
INSERT INTO PRODUCT_IO (IO_NUM, PRODUCT_ID, AMOUNT, STATUS) VALUES (IO_NUM_AUTO_INCREMENTS_SEQ.nextval,'pc_ibm',10,'입고');
commit;

-- 상품 전체 조회 JOIN PRODUCT STOCK
SELECT * FROM PRODUCT_IO JOIN PRODUCT_STOCK PS on PS.PRODUCT_ID = PRODUCT_IO.PRODUCT_ID;
...
-- 상품 입고내역 조회
SELECT * FROM PRODUCT_IO JOIN PRODUCT_STOCK PS on PS.PRODUCT_ID = PRODUCT_IO.PRODUCT_ID WHERE STATUS = '입고';
